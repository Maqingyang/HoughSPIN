...
def process_image_bbox(img, bbox, input_res=224):
        ...
        while img_id < num_imgs-1:
            ...
            if gt_data == []:
                ...
                for bbox in bbox_list:
                    ...
                    args.bbox = bbox
                    args.img = osp.join('/project/lighttrack/data/Data_2018/posetrack_data',img_path)
                    args.outfile = osp.join("posetrack_vis", osp.basename(args.img))
